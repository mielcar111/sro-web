 ...
 * _GuildChest) referans oyun modelini tasiyamiyor: metin lonca kimligi, xp/rating/
 ...
 *
 * Calistirma:
 *   sqlcmd -S localhost -U sa -P <sa-parolaniz> -d SRO_WEB_GAME -i sistem_lonca_sema.sql
 * ============================================================================= */
