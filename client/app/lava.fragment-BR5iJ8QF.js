...
`;e.ShadersStoreWGSL[m]||(e.ShadersStoreWGSL[m]=h);var g=[i,a,l,u,p,f,d,o,n,c,t,r,s];for(let t of g)e.IncludesShadersStoreWGSL[t.name]||(e.IncludesShadersStoreWGSL[t.name]=t.shader);var _={name:m,shader:h};export{_ as lavaPixelShaderWGSL};