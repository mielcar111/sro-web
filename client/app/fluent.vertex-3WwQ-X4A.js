import{t as e}from"./shaderStore-D-XQlhUT.js";var t=`fluentVertexShader`,n=`attribute position: vec3f;attribute normal: vec3f;attribute uv: vec2f;uniform world: mat4x4f;uniform viewProjection: mat4x4f;varying vUV: vec2f;
#ifdef BORDER
...
`;e.ShadersStoreWGSL[t]||(e.ShadersStoreWGSL[t]=n);var r={name:t,shader:n};export{r as fluentVertexShaderWGSL};