import{t as e}from"./shaderStore-D-XQlhUT.js";import{$ as t,M as n,Q as r,St as i,at as a,bt as o,d as s,et as c,it as l,rt as u,tt as d,ut as f,xt as p}from"./index-DzRqDn3Z.js";var m=`triplanarPixelShader`,h=`uniform vEyePosition: vec4f;uniform vDiffuseColor: vec4f;
#ifdef SPECULARTERM
...
`;e.ShadersStoreWGSL[m]||(e.ShadersStoreWGSL[m]=h);var g=[i,a,f,l,u,p,d,o,n,c,t,r,s];for(let t of g)e.IncludesShadersStoreWGSL[t.name]||(e.IncludesShadersStoreWGSL[t.name]=t.shader);var _={name:m,shader:h};export{_ as triplanarPixelShaderWGSL};