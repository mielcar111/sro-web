import{t as e}from"./shaderStore-D-XQlhUT.js";import{$ as t,Q as n,St as r,at as i,bt as a,et as o,it as s,nt as c,ot as l,rt as u,tt as d,ut as f,xt as p}from"./index-DzRqDn3Z.js";var m=`waterPixelShader`,h=`uniform vEyePosition: vec4f;uniform vDiffuseColor: vec4f;
#ifdef SPECULARTERM
...
`;e.ShadersStoreWGSL[m]||(e.ShadersStoreWGSL[m]=h);var g=[r,l,c,i,s,u,p,f,d,a,o,t,n];for(let t of g)e.IncludesShadersStoreWGSL[t.name]||(e.IncludesShadersStoreWGSL[t.name]=t.shader);var _={name:m,shader:h};export{_ as waterPixelShaderWGSL};