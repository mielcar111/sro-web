import{t as e}from"./shaderStore-D-XQlhUT.js";import{Bt as t,Lt as n,Mt as r,Nt as i,P as a,Pt as o,St as s,Vt as c,ct as l,dt as u,ft as d,lt as f,p,st as m,ut as h,vt as g,yt as _}from"./index-DzRqDn3Z.js";var v=`triplanarVertexShader`,y=`attribute position: vec3f;
#ifdef NORMAL
...
`;e.ShadersStoreWGSL[v]||(e.ShadersStoreWGSL[v]=y);var b=[s,c,t,n,_,h,d,p,u,o,i,r,g,m,f,l,a];for(let t of b)e.IncludesShadersStoreWGSL[t.name]||(e.IncludesShadersStoreWGSL[t.name]=t.shader);var x={name:v,shader:y};export{x as triplanarVertexShaderWGSL};