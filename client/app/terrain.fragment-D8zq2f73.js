import{t as e}from"./shaderStore-D-XQlhUT.js";import{A as t,B as n,Dt as r,Et as i,G as a,H as o,L as s,R as c,Tt as l,U as u,W as d,X as f,f as p,z as m}from"./index-DzRqDn3Z.js";var h=`terrainPixelShader`,g=`precision highp float;uniform vec4 vEyePosition;uniform vec4 vDiffuseColor;
#ifdef SPECULARTERM
...
`;e.ShadersStore[h]||(e.ShadersStore[h]=g);var _=[r,a,d,u,o,i,f,n,l,t,m,c,s,p];for(let t of _)e.IncludesShadersStore[t.name]||(e.IncludesShadersStore[t.name]=t.shader);var v={name:h,shader:g};export{v as terrainPixelShader};