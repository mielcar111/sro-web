import{t as e}from"./shaderStore-D-XQlhUT.js";import{Bt as t,Lt as n,Mt as r,Nt as i,P as a,Pt as o,Vt as s,ct as c,dt as l,ft as u,lt as d,p as f,st as p,ut as m,vt as h,yt as g}from"./index-DzRqDn3Z.js";var _=`waterVertexShader`,v=`attribute position: vec3f;
#ifdef NORMAL
...
`;e.ShadersStoreWGSL[_]||(e.ShadersStoreWGSL[_]=v);var y=[s,t,n,g,u,f,l,m,o,i,r,h,d,c,a,p];for(let t of y)e.IncludesShadersStoreWGSL[t.name]||(e.IncludesShadersStoreWGSL[t.name]=t.shader);var b={name:_,shader:v};export{b as waterVertexShaderWGSL};