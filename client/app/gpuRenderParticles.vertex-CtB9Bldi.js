import{t as e}from"./shaderStore-D-XQlhUT.js";import{ft as t,lt as n,st as r,ut as i,vt as a,yt as o}from"./index-DzRqDn3Z.js";var s=`gpuRenderParticlesVertexShader`,c=`uniform view: mat4x4f;uniform projection: mat4x4f;uniform translationPivot: vec2f;uniform worldOffset: vec3f;
#ifdef LOCAL
...
`;e.ShadersStoreWGSL[s]||(e.ShadersStoreWGSL[s]=c);var l=[o,t,i,a,n,r];for(let t of l)e.IncludesShadersStoreWGSL[t.name]||(e.IncludesShadersStoreWGSL[t.name]=t.shader);var u={name:s,shader:c};export{u as gpuRenderParticlesVertexShaderWGSL};