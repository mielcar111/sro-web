import{t as e}from"./shaderStore-D-XQlhUT.js";import{B as t,Et as n,L as r,R as i,Tt as a,X as o,f as s}from"./index-DzRqDn3Z.js";var c=`gridPixelShader`,l=`#extension GL_OES_standard_derivatives : enable
...
`;e.ShadersStore[c]||(e.ShadersStore[c]=l);var u=[n,o,t,a,r,i,s];for(let t of u)e.IncludesShadersStore[t.name]||(e.IncludesShadersStore[t.name]=t.shader);var d={name:c,shader:l};export{d as gridPixelShader};