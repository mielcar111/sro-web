import{t as e}from"./shaderStore-D-XQlhUT.js";import{N as t,St as n}from"./index-DzRqDn3Z.js";var r=`fibonacci`,i=`fn rcp(x: f32)->f32
{return 1./x;}
...
`;e.ShadersStoreWGSL[l]||(e.ShadersStoreWGSL[l]=u);var d=[n,a,t,c];for(let t of d)e.IncludesShadersStoreWGSL[t.name]||(e.IncludesShadersStoreWGSL[t.name]=t.shader);var f={name:l,shader:u};export{f as subSurfaceScatteringPixelShaderWGSL};