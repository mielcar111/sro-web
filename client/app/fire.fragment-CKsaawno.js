import{t as e}from"./shaderStore-D-XQlhUT.js";import{$ as t,M as n,Q as r,bt as i,d as a,tt as o,ut as s,xt as c}from"./index-DzRqDn3Z.js";var l=`firePixelShader`,u=`uniform vEyePosition: vec4f;varying vPositionW: vec3f;
#ifdef VERTEXCOLOR
...
`;e.ShadersStoreWGSL[l]||(e.ShadersStoreWGSL[l]=u);var d=[c,s,o,i,n,t,r,a];for(let t of d)e.IncludesShadersStoreWGSL[t.name]||(e.IncludesShadersStoreWGSL[t.name]=t.shader);var f={name:l,shader:u};export{f as firePixelShaderWGSL};