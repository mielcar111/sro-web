import{t as e}from"./shaderStore-D-XQlhUT.js";import{B as t,Dt as n,Et as r,G as i,H as a,K as o,L as s,R as c,Tt as l,U as u,V as d,W as f,X as p,z as m}from"./index-DzRqDn3Z.js";var h=`waterPixelShader`,g=`#ifdef LOGARITHMICDEPTH
...
`;e.ShadersStore[h]||(e.ShadersStore[h]=g);var _=[n,o,d,i,f,u,a,r,p,t,l,m,c,s];for(let t of _)e.IncludesShadersStore[t.name]||(e.IncludesShadersStore[t.name]=t.shader);var v={name:h,shader:g};export{v as waterPixelShader};